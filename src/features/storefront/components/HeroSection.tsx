        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-obsidian">
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link
                        href="/#featured"
                        className="group px-10 py-4 bg-gold text-obsidian font-medium tracking-widest text-sm uppercase transition-all duration-300 hover:bg-gold-light hover:shadow-[0_0_30px_rgba(212,175,55,0.3)]"
                    >
                        Explore Collection
                    </Link>
                    <Link
                        href="/#about"
                        className="px-10 py-4 border border-warm-gray/30 text-warm-gray tracking-widest text-sm uppercase transition-all duration-300 hover:border-gold hover:text-gold"
                    >
                        Our Story
                    </Link>
                </div>
