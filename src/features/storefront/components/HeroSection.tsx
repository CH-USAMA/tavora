...
export function HeroSection() {
    ...
    const message = encodeURIComponent("Hi! I'd like to know more about your luxury timepieces.");
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-obsidian">
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-20">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-[9rem] font-serif text-white mb-6 leading-[1.0] tracking-tight drop-shadow-2xl">
                    Time,{" "}
                ...
                <p className="text-lg md:text-xl text-warm-gray/90 max-w-2xl mx-auto mb-14 leading-relaxed font-light">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link href="/shop" className="group relative px-10 py-4 bg-gold text-black font-semibold tracking-[0.15em] text-sm uppercase transition-all duration-300 overflow-hidden shadow-[0_0_35px_rgba(212,175,55,0.35)] hover:shadow-[0_0_50px_rgba(212,175,55,0.5)]">
                    ...
                    <a 
                        ...
                        className="flex items-center gap-2.5 px-10 py-4 border border-[#25D366]/50 text-[#25D366] tracking-[0.15em] text-sm uppercase transition-all duration-300 hover:bg-[#25D366]/10 hover:border-[#25D366] backdrop-blur-sm"
                    >
                    ...
                    <Link href="/#about" className="px-10 py-4 border border-white/20 text-white/70 tracking-[0.15em] text-sm uppercase transition-all duration-300 hover:border-gold/40 hover:text-gold hover:bg-gold/5 backdrop-blur-sm">
                        Our Story
                    </Link>
                </div>
            ...
            {/* Scroll Indicator */}
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 opacity-40 hover:opacity-80 transition-opacity cursor-pointer">
